...
crs = layer.crs()
corrected_layer = QgsVectorLayer(f'{layer.geometryType()}?crs={crs.authid()}', 'Ejemplo_Cuernavaca_Corregido', 'memory')
...
for feature in layer.getFeatures():
    ...
    corrected_provider.addFeature(new_feature)
    num_features += 1
...
print(f'Número de características agregadas a la capa corregida: {num_features}')
